...
printBtn.addEventListener("click", () => {
     ...
     printWindow.document.write('<link rel="stylesheet" href="style.css" /><link rel="stylesheet" href="style_print.css" />');
...
function createArticleDatabase(articleData) {
     ...
     articleData.forEach((element) => {
          ...
          // let newArticleContent = document.createElement("p");
          // let tmpHtml = "";
          // let tmpContentAry = element.content.split(/[\n\r\u0003]+/);
          // let listing = false;
          // console.log(tmpContentAry);
          // for (let i = 0; i < tmpContentAry.length; i++) {
          //      if (tmpContentAry[i].substr(0, 1).match(/[▪①]/)) {
...
const initSortableList = (e) => {
     ...
     let nextSibling = siblings.find((sibling) => {
          return document.querySelector(".right-container").scrollTop + e.clientY <= sibling.offsetTop + sibling.offsetHeight / 2;
     });
